...
# Groups
    ...
    def user(self, id, expand=None, use_account_id=False):
        """Get a user Resource from the server.

        :param id: Account id or username of the user to get
        :param expand: extra information to fetch inside each resource
        """
        user = User(self._options, self._session, use_account_id=use_account_id)
        params = {}
        if expand is not None:
            params['expand'] = expand
